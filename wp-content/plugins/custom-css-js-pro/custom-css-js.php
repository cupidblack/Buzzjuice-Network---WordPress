...
update_option('ccj_license_key', '1415b451be1a13c283ba771ea52d38bb');
update_option('ccj_license_status', 'valid');
	...
	final class CustomCSSandJSpro {
		...
		function initiate_show_codes() {
			...
			if ( is_multisite() && version_compare( $wp_version, '4.9.0', '>=' ) && ! is_main_site() ) {
				...
				if ( ! get_site_option( 'ccj_multisite_js_loginpage', false ) ) {
