...
//BlueCrownR&D
	public function __construct() {
		// Delay the dependency check to the 'init' action instead of 'plugins_loaded'.
		add_action( 'init', [ $this, 'check_dependencies_on_init' ] );
	}
...
//BlueCrownR&D
	/**
	 * Callback function for the 'init' action to check dependencies.
	 *
	 * @since 2.0.0
	 *
	 * @return void
	 */
//BlueCrownR&D
	public function check_dependencies_on_init() {
