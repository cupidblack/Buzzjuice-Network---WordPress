...
/* harmony export */   getContentWrapper: () => (/* binding */ getContentWrapper),
/* harmony export */   scrollWrapperTo: () => (/* binding */ scrollWrapperTo)
/* harmony export */ });
/**
...
/* harmony import */ var _affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @affiliatewp-portal/dom-helpers */ "./src/dom-helpers/dom-helpers.js");
/* harmony import */ var _affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @affiliatewp-portal/url-helpers */ "./src/url-helpers/url-helpers.js");
/**
 * Table.
 *
...
const page = (0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_4__.getPage)(window.location.href);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  urlForPage(page) {
    ...
    return (0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_4__.paginateUrl)(window.location.href, args);
  },
  /**
   * Get Cell.
   *
  ...
  handleOrderEvent(e, orderby) {
    ...
    if (true === this.allowSorting) {
      (0,_affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_3__.scrollWrapperTo)((0,_affiliatewp_portal_dom_helpers__WEBPACK_IMPORTED_MODULE_3__.getContentWrapper)().scrollleft, 0);
  ...
  fetchPage(page, skipHistory = false) {
    ...
    return new Promise(async (res, rej) => {
      const data = await (0,_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_2__.portalSchemaRows)(this.type, args);
      this.rows = data.rows;
  ...
  updateUrl(args, skipHistory = false) {
    ...
    if (false === skipHistory && false !== this.showPagination && undefined !== this.showPagination) {
      window.history.pushState(undefined, document.title, (0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_4__.paginateUrl)(window.location.href, args));
    }
  },
  /**
   * Setup Columns.
   ...
   */
  async init() {
    const currentPage = (0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_4__.getPage)(window.location.href);
    if (false === this.order && (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.hasQueryArg)(window.location.href, 'order')) {
      this.order = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.getQueryArg)(window.location.href, 'order');
    }
    if (false === this.orderby && (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.hasQueryArg)(window.location.href, 'orderby')) {
      this.orderby = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.getQueryArg)(window.location.href, 'orderby');
    }
    this.setupColumns();
...
((window.AFFWP = window.AFFWP || {}).portal = window.AFFWP.portal || {}).alpineTable = __webpack_exports__;
/******/ })()
;
