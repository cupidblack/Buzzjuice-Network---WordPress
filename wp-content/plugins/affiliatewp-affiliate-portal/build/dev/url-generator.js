...
/* harmony import */ var _affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @affiliatewp-portal/clipboard-helpers */ "./src/clipboard-helpers/clipboard-helpers.js");
...
function urlGenerator() {
  return {
     ...
     * @type string
     */
    defaultCopyMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Copy link', 'affiliatewp-affiliate-portal'),
    /**
     ...
     * @type string
     */
    defaultErrorMessage: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Invalid URL', 'affiliatewp-affiliate-portal'),
    /**
     * URL listing getter.
     *
     ...
     */
    set urls(value) {
      AFFWP.portal.core.store.set('urlGeneratorUrls', {
        ...this.urls,
        ...value
      });
    },
    ...
    generateUrl(type) {
      ...
      if (true === this.prettyAffiliateUrls) {
        inputUrl = (0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__.appendUrl)(inputUrl, `${this.referralVar}/${this.referralFormatValue}`);
      ...
      inputUrl = encodeURI((0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.safeDecodeURI)(inputUrl));

      // Set query paramaters based on generated argus.
      const url = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.addQueryArgs)(inputUrl, args);
    ...
    async setCopy(type) {
      ...
      try {
        await (0,_affiliatewp_portal_clipboard_helpers__WEBPACK_IMPORTED_MODULE_5__.copy)(urlObject.url);
        urlObject.copyMessage = `🎉 ${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Copied!', 'affiliatewp-affiliate-portal')}`;
      } catch {
        urlObject.copyMessage = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Could not copy to clipboard', 'affiliatewp-affiliate-portal');
      }

      // After 2 seconds, reset the message.
      await (0,_affiliatewp_portal_helpers__WEBPACK_IMPORTED_MODULE_4__.pause)(2000);
    ...
    async init() {
      // Fetch the raw data.
      const [affiliate, settings] = await Promise.all([(0,_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_3__.portalAffiliate)(), (0,_affiliatewp_portal_sdk__WEBPACK_IMPORTED_MODULE_3__.portalSettings)()]);
      // Set object values from fetch'd data.
      this.baseAuthority = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.getAuthority)(affiliate.base_url);
      ...
      this.pageUrlLabel = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)(`Enter any valid page URL from ${affiliate.base_url}`, 'affiliatewp-affiliate-portal');

      // Set initial URL Objects
      this.urls = {
        generated: this.urlObject({
          url: affiliate.base_url
        }),
        referral: this.urlObject({
          url: this.getUrlParam('generated', 'url')
        })
      };
    ...
    urlObject(args) {
      ...
      if ((0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__.hasValidProtocol)(result.url) && ((0,_affiliatewp_portal_url_helpers__WEBPACK_IMPORTED_MODULE_6__.authoritiesMatch)(result.url, this.baseAuthority) || true === this.bypassUrlAuthority)) {
...
((window.AFFWP = window.AFFWP || {}).portal = window.AFFWP.portal || {}).urlGenerator = __webpack_exports__;
/******/ })()
;
